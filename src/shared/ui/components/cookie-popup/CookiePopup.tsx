...
export const CookiePopup = () => {
  ...
  return (
    <div className={styles.cookiePopup} role="dialog" aria-live="polite" aria-label={t('title', { fallback: 'Cookie Notice' })}>
      <div className={styles.content}>
        <div className={styles.copy}>
          <h2 className={styles.title}>{t('title', { fallback: 'Cookie Notice' })}</h2>

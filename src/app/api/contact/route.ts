...
<head>
    ...
    <title>Order Received - netspiredev </title>
</head>
                ...
                <table role="presentation"
                    ...
                    <tr>
                        <td style="padding: 0;height: 100px;">
                            ...
                            <img style="width: 100%;height: auto;" src="https://netspiredev .com/images/mail-header.png"
                                alt="netspiredev  Logo">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 32px;background: #000;">
                            ...
                            font-weight: 300;
                            line-height: normal;">
                               Thank you for contacting <b>netspiredev </b>.
                            </p>
                            ...
                            line-height: normal;">
                                Kind regards,<br>
                                <strong style="color: #ffffff;">The netspiredev  Team</strong>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="border-top: 1px solid #222; padding: 24px 30px; background: #000;">
                            <a href="mailto:info@netspiredev .com" style="color: #FFF;
                            font-size: 10px;
                            font-style: normal;
                            font-weight: 400;
                            line-height: normal;
                            ...
                            text-decoration: none;">
                                <img style="margin-right: 8px;margin-bottom: -2px;" width="14" height="14"
                                    src="https://netspiredev .com/images/mail-icon.png" alt="netspiredev  Mail Icon">
                                info@netspiredev .com
                            </a>
                            <img style="width: 124.695px;height: 20px; float: right;"
                                src="https://netspiredev .com/images/mail-logo.png" alt="netspiredev  Mail Icon">
                        </td>
                    </tr>
                </table>
            </td>
